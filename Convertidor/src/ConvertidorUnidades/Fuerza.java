 ...
 */
/**
*Clase para convertir la fuerza a diferentes unidades de medida 
*/
public class Fuerza {

/**
*Convierte Dina a otras unidades
...
/**
*Convierte la LibraFuerza a otras unidades
* @param valor es el número ingresado
* @param unidadDestino es la unidad en la que se quiere convertir 
* @return La equivalencia de la unidad recibida a la deseada
*/
...
/**
*Convierte los KilogramoFuerza a otras unidades
* @param valor es el número ingresado
* @param unidadDestino es la unidad en la que se quiere convertir 
* @return La equivalencia de la unidad recibida a la deseada
*/
...
/**
*Convierte los Newton a otras unidades
* @param valor es el número ingresado
* @param unidadDestino es la unidad en la que se quiere convertir 
* @return La equivalencia de la unidad recibida a la deseada
*/
...
/**
*Convierte los KiloNewton a otras unidades
* @param valor es el número ingresado
* @param unidadDestino es la unidad en la que se quiere convertir 
* @return La equivalencia de la unidad recibida a la deseada
*/
...
/**
*Convierte las ToneladasFuerza a otras unidades
* @param valor es el número ingresado
* @param unidadDestino es la unidad en la que se quiere convertir 
* @return La equivalencia de la unidad recibida a la deseada
*/
...
/**
*Convierte los MiliNewton a otras unidades
* @param valor es el número ingresado
* @param unidadDestino es la unidad en la que se quiere convertir 
* @return La equivalencia de la unidad recibida a la deseada
*/
